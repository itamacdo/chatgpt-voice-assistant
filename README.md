...
O usuário digita uma mensagem (simulando Speech-to-Text)

O texto é enviado ao ChatGPT

O ChatGPT retorna uma resposta em texto
...
Sinta-se livre para usar, modificar e evoluir conforme sua necessidade.
